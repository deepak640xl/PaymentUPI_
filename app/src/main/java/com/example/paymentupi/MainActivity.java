package com.example.paymentupi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(view -> {
            if (TextUtils.isEmpty(name.getText().toString().trim())){
                ...
                Toast.makeText(MainActivity.this," Payment Note is invalid", Toast.LENGTH_SHORT).show();

            }else if (TextUtils.isEmpty(amount.toString().trim())){
                ...
                payUsingUpi(name.getText().toString(), upivirtualid.getText().toString(),
                        note.getText().toString(), amount.toString());
